...
import { Menu, LayoutDashboard, BookOpen, LogOut, User } from "lucide-react";
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-[250px]">
              <SheetHeader className="text-left mb-8">
                <SheetTitle>SocketasService</SheetTitle>
              </SheetHeader>
              ...
              <div className="flex flex-col gap-4">
                {navItems.map((item) => (
                  <Link
                    key={item.path}
                    to={item.path}
                    className={`flex items-center gap-3 px-2 py-2 text-sm font-medium rounded-md ${
                      isActive(item.path)
